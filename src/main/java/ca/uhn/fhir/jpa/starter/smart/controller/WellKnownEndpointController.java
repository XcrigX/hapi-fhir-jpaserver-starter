...
public class WellKnownEndpointController {
	 ...
	 * WellKnownEndpointController controller = new WellKnownEndpointController();
	 * controller.issuer = "issuerx"; controller.responseTypesSupported = new
	 * String[2]; controller.responseTypesSupported[0] = "111";
	 * controller.responseTypesSupported[1] = "222";
	 * 
	 * System.out.println(controller.getWellKnownJson()); }
	 */
